...
function selectHotel(type, name) {
    ...
    const DIY_CATEGORIES = [
        ...
        { id: 'flight', title: 'ตั๋วเครื่องบิน', desc: 'จองสายการบินชั้นนำโดยผู้เชี่ยวชาญ และพร้อมให้คำแนะนำตามทุกความประสงค์ของคุณ', price: 'ราคาเริ่มต้นที่ 22,000 บาท', hasPlaneImg: true, cardStyle: 'light' },        
        { id: 'car', title: 'รถ', 
